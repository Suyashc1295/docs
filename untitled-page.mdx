...
Core servers means Google Ads, Tag Manager, Search Console, and Google Analytics. Free access ends after 200 credits or 14 days, whichever comes first. Additional Agency seats cost \$25 per month each.
...
- LinkedIn Ads is not included in the current plans and remains on the product roadmap.
...
Billing access and Google permissions are separate. Reconnect the relevant Google service with an account that can access the resource.
